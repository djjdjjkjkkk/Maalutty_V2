...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'MADE BY ❤️MAALUTTY💙' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '917025868709@s.whatsapp.net' : process.env.TAG_REPLY,

...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            chalk.green.bold('❤️ MAALUTTY 💙 WORKING✅ ' + config.WORKTYPE + ' public 👻'));
            await conn.sendMessage(conn.user.jid, "❤️MAALUTTY💙 ELLAM SETTAYI POLICHU MAKKALE☺️", MessageType.text);
...
*/
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '❤️MAALUTTY💙[error] ' +
                                    '\n\n*👻 ' + error + '*\n'
                                    , MessageType.text);
                            }
                        }
